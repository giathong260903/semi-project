...
<html lang="en">
   <head>
      ...
      <!--animate css-->
      <!-- <link rel="stylesheet" href="public/front/css/animate-wow.css"> -->
      <link rel="stylesheet" href="{{asset('css/animate-wow.css')}}">
      <!--main css-->
      <!-- <link rel="stylesheet" href="public/front/css/style.css"> -->
      <link rel="stylesheet" href="{{asset('css/style.css')}}">
      <!-- <link rel="stylesheet" href="public/front/css/bootstrap-select.min.css"> -->
      <link rel="stylesheet" href="{{asset('css/bootstrap-select.min.css')}}">
      <!-- <link rel="stylesheet" href="public/front/css/slick.min.css"> -->
